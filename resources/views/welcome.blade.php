...
<body class="bg-gray-50 font-sans antialiased">
                ...
                <div class="space-y-8 lg:pr-8">
                    ...
                    <div class="hero-title hero-title-delay">
                        <h1 class="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-[1.1] tracking-tight">
                            ...
                            <span class="block text-3xl sm:text-4xl lg:text-5xl font-bold text-white/80 mt-2 tracking-normal">& Sembako Terlengkap</span>
                        </h1>
                    </div>

                    <!-- Subtitle -->
                    <p class="hero-subtitle text-lg text-green-100/80 max-w-lg leading-relaxed font-light">
                ...
                <div class="space-y-6 reveal">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div><h3 class="font-bold text-gray-800">Aneka Pisang</h3><p class="text-sm text-gray-500">Segar & olahan berkualitas</p></div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center shrink-0"><span class="text-xl">🛒</span></div>
                            <div><h3 class="font-bold text-gray-800">Sembako Lengkap</h3><p class="text-sm text-gray-500">Kebutuhan pokok harian</p></div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center shrink-0"><span class="text-xl">💰</span></div>
                            <div><h3 class="font-bold text-gray-800">Harga Grosir</h3><p class="text-sm text-gray-500">Harga bersaing</p></div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center shrink-0"><span class="text-xl">✅</span></div>
                            <div><h3 class="font-bold text-gray-800">Kualitas Terjamin</h3><p class="text-sm text-gray-500">Produk pilihan terbaik</p></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div class="flex gap-3 mt-4">
                        <a href="https://web.whatsapp.com/send?phone=6287824443944" target="_blank" aria-label="WhatsApp Rizky Pisang" class="w-10 h-10 bg-green-600 rounded-xl flex items-center justify-center hover:bg-green-500 transition-colors">
    ...
    <!-- WhatsApp Floating -->
    <a href="https://web.whatsapp.com/send?phone=6287824443944&text=Halo%2C%20saya%20ingin%20bertanya%20tentang%20produk%20Rizky%20Pisang" target="_blank"
       aria-label="Chat WhatsApp Rizky Pisang"
